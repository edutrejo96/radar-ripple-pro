...
BUILD_ID = "v74_2026_05_11_RADAR_FM_AUTOPLAY_COMPONENT_ROUTE_LIVE"
BUILD_NOTE = "Radar FM HTML con siguiente automático + fichas A→B vivas"
        ...
        st.markdown(
            ...
            <div style="border:1px solid rgba(34,211,238,.32);border-radius:18px;
              ...
              <div style="display:flex;align-items:center;justify-content:space-between;gap:.8rem;">
                ...
                <div style="font-size:.72rem;color:#94A3B8;border:1px solid rgba(148,163,184,.28);border-radius:999px;padding:.12rem .55rem;">auto-next HTML · static/musica · v74</div>
              </div>
            """,
            unsafe_allow_html=True,
        )
...
"""
        ...
        with st.expander("🔎 Diagnóstico Radar FM", expanded=False):
            st.write("Modo:", "HTML audio component v74")
